...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnAdd,btnDelete,btnModify,btnView,bntViewAll,btnShowinfo;
    SQLiteDatabase db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bntViewAll=findViewById(R.id.buttonViewAll);
        btnShowinfo=findViewById(R.id.buttonshow);

        btnAdd.setOnClickListener(this);
        btnDelete.setOnClickListener(this);
        btnModify.setOnClickListener(this);
        btnView.setOnClickListener(this);
        bntViewAll.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.buttonshow:
                ...
                showmsg("Devloped by niranjan", "NSD");
                break;
    ...
    private void showmsg(String error, String invalid_input) {
